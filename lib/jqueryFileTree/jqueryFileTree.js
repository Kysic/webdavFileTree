	...
	$.extend($.fn, {
		fileTree: function(o, h) {
			...
			if( o.ajaxConnector == undefined ) {
			    o.ajaxConnector = function(dir, connectorCallback) {
					$.post(o.script, { dir: encodeURI(dir) }, connectorCallback);
			    };
			}
			...
			$(this).each( function() {
				...
				function showTree(c, dir) {
					...
					o.ajaxConnector(dir, function(data) {
						$(c).find('.start').html('');
						$(c).removeClass('wait').append(data);
						if( o.root == dir ) $(c).find('UL:hidden').show();
